...
public interface RuntimeCondition {
    ...
    /**
     * Do the conditions.
     * @param parent The statement container.
     * @return The condition status (<code>true/false</code>)
     * @throws ScriptException If an exception occured while executing the script.
     */
    boolean run(CodeChunk parent) throws ScriptException;
}
